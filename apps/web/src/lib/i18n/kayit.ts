...
const tr = {
  ...
  alerjiDetay: "Alerji var ise detayları",
  hastalikSoru: "Öğrencinin herhangi bir hastalığı var mı?",
  hastalikDetay: "Hastalık var ise detayları",
  fobiSoru: "Öğrencinin herhangi bir fobisi var mı?",
  fobiDetay: "Fobi var ise detayları",
  evet: "Evet",
  hayir: "Hayır",
...
const ku: KayitStrings = {
  ...
  alerjiDetay: "Ger hebe, hûrgilî",
  hastalikSoru: "Nexweşiyeke xwendekar heye?",
  hastalikDetay: "Ger hebe, hûrgilî",
  fobiSoru: "Fobiyeke xwendekar heye?",
  fobiDetay: "Ger hebe, hûrgilî",
  evet: "Erê",
  hayir: "Na",
...
const ar: KayitStrings = {
  ...
  alerjiDetay: "إن كانت الإجابة نعم، التفاصيل",
  hastalikSoru: "هل لدى الطالب أي مرض؟",
  hastalikDetay: "إن كانت الإجابة نعم، التفاصيل",
  fobiSoru: "هل لدى الطالب أي رهاب؟",
  fobiDetay: "إن كانت الإجابة نعم، التفاصيل",
  evet: "نعم",
  hayir: "لا",
